...
// shuffle.js JS files into /js
	gulp.src( `${paths.node}shufflejs/dist/shuffle.min.js` )
	.pipe( gulp.dest( `${paths.js}` ) );
	gulp.src( `${paths.node}shufflejs/dist/shuffle.min.js.map` )
	.pipe( gulp.dest( `${paths.js}` ) );


// glightbox.js JS files into /js ans CSS into /css
	gulp.src( `${paths.node}glightbox/dist/js/glightbox.min.js` )
	.pipe( gulp.dest( `${paths.js}` ) );

	gulp.src( `${paths.node}glightbox/dist/css/glightbox.min.css` )
	.pipe( gulp.dest( `${paths.css}` ) );
